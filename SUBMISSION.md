...
Python, Strands Agents SDK, Amazon Bedrock AgentCore, Amazon DynamoDB, Amazon S3, Amazon Transcribe, AWS Secrets Manager, Amazon EventBridge Scheduler, AWS Lambda, Google Gemini API, Google Calendar API, Gmail API, Tavily Search API, FastAPI, Pydantic, pytest, moto, TypeScript, React, React Flow, Zustand, Vite
...
Hosted demo: see the Try it out link on this submission.
