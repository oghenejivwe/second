...
Hosted demo, no install: https://second-blush-ten.vercel.app. Sign in with judge / second-demo (both fields are pre-filled). It runs the same example data, labelled "fixtures" on screen.
